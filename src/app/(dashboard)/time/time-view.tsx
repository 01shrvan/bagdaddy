      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit((d) => create.mutate(d))} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={create.isPending}>{create.isPending ? "Saving..." : "Log time"}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
...
export function TimeView() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 p-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-3">
            ...
            <Button size="sm" variant="outline" onClick={() => setDialogOpen(true)}>Log time</Button>
          </div>
        ) : (
      ...
      <LogTimeDialog open={dialogOpen} onClose={() => setDialogOpen(false)} />
