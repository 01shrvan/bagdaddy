...
function ProjectDialog({ open, onClose, row }: { open: boolean; onClose: () => void; row?: Row }) {
  const trpc = useTRPC();
...
export function ProjectsView() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 p-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-3">
            ...
            <Button size="sm" variant="outline" onClick={() => setDialogOpen(true)}>New project</Button>
          </div>
        ) : (
                    ...
                    <TableCell>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => { setEditing({ project, clientName }); setDialogOpen(true); }}>
      ...
      <ProjectDialog open={dialogOpen} onClose={() => setDialogOpen(false)} row={editing} />
