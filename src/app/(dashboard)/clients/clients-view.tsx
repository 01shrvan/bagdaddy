      ...
      <DialogContent className="sm:max-w-md">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <DialogFooter>
            ...
            <Button type="submit" disabled={isPending}>{isPending ? "Saving..." : isEdit ? "Save changes" : "Create client"}</Button>
          </DialogFooter>
        </form>
      </DialogContent>
    </Dialog>
...
export function ClientsView() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex-1 p-6">
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-24 gap-3">
            ...
            <Button size="sm" variant="outline" onClick={() => setDialogOpen(true)}>Add client</Button>
          </div>
        ) : (
      ...
      <ClientDialog open={dialogOpen} onClose={() => setDialogOpen(false)} client={editing} />

      <AlertDialog open={!!deleteId} onOpenChange={(v) => { if (!v) setDeleteId(null); }}>
        <AlertDialogContent>
          <AlertDialogHeader>
            <AlertDialogTitle>Delete client?</AlertDialogTitle>
            <AlertDialogDescription>This will also delete all associated projects and data. This cannot be undone.</AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
