...
const FEATURES = [
  {
    ...
    desc: "Create, customize, and share invoices via a public link — no account needed for your client.",
  },
  {
    icon: Clock01Icon,
    title: "Time tracking",
    desc: "Log hours against projects with one click. See total time and earnings per project instantly.",
  },
  {
    icon: DollarSquareIcon,
    title: "Earnings overview",
    desc: "Dashboard shows total earned, outstanding, and per-project breakdown at a glance.",
  },
  {
    icon: Link01Icon,
    title: "Public invoice links",
    desc: "Every invoice gets a unique shareable URL. Copy the link, send it — client sees a clean page.",
  },
  {
    icon: Alert02Icon,
    title: "Auto overdue detection",
    desc: "Invoices past their due date automatically flip to overdue. No manual chasing required.",
  },
  {
    icon: AddInvoiceIcon,
    title: "Instant invoice generation",
    desc: "Turn logged time entries into invoice line items in one click. Hours × rate = done.",
  },
];
